...
- [ ] Unit tests pass: `nvm exec 20 npm test`
- [ ] TypeScript compilation succeeds: `nvm exec 20 npm run build`
- [ ] Add integration tests for SOAP error handling:
...
- [ ] Wrapper function is well-documented
